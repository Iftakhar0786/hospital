...
#now we are checking user is doctor , patient or admin
def is_admin(user):
...
# CHECK USERNAME AND PASSWORD OR ADMIN,DOCTOR OR PATIENT
...
def patient_book_appointment_view(request):
    ...
    patient=models.Patient.objects.get(user_id=request.user.id) #for profile picture patient 
    message=None
